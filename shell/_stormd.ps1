...
Register-ArgumentCompleter -Native -CommandName 'stormd' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'stormd' {
            ...
            [CompletionResult]::new('-e', 'e', [CompletionResultType]::ParameterName, 'ZMQ socket name/address for storm node RPC interface')
            [CompletionResult]::new('--ext-endpoint', 'ext-endpoint', [CompletionResultType]::ParameterName, 'ZMQ socket name/address for storm node RPC interface')
